...
{
	ADTF_DECLARE_FILTER_VERSION(OID_ADTF_Stopline2oneslot, "crossline2slot", adtf::OBJCAT_Tool, "AADC Stopline2oneslot", 1, 0, 0, "Beta Version");
...
private: // private methods
	...
	tBool stop_detect;
     ...
     tFloat32 m_edgeselected;
     tBool edge_detect,left,right,straight;
